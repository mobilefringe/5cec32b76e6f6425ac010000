<template>
    <div class="inside_header_background" v-if="pageBanner" :style="{ background: 'linear-gradient(0deg, rgba(215, 78, 34, 0.8), rgba(245, 111, 68, 0.8)), url(' + pageBanner.image_url + ') center center no-repeat rgba(215, 78, 34)' }">
