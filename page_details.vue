    ...
    <div> <!-- without an outer container div this component template will not render -->
        ...
        <transition name="fade">
            <div v-if="dataLoaded" v-cloak>
                <div class="inside_header_background" :style="{ background: 'linear-gradient(0deg, rgba(215, 78, 34, 0.8), rgba(215, 78, 34, 0.8)), url(' + pageBanner.image_url + ') center center no-repeat rgba(215, 78, 34)' }">
